        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5 mt-3">
                        <div class="md:flex-1">
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}" class="bg-indigo-500 border border-indigo-500 p-3 text-sm uppercase font-bold  rounded-lg block text-center" >
                                Ver vacante
                            </a>
                        </div>
